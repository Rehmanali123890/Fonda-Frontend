...
@Component({
  ...
  styleUrls: ['./storefront-details.component.css']
})
export class StorefrontDetailsComponent {
  startDate: string
  endDate: string
  source: string
  type: string
  ...
  downloadTransactionReport() {
    ...
    const platform = "storefront"; // Use the platform you're interested in
  ...
  downloadOriginalFile(format: string) {
    ...
    const fileName = `Storefront Transaction Summary Report - ${this.selectedMerchant} (from ${startDate} to ${endDate})`;
